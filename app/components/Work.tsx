...
const Work = () => {
  return (
    <div id="work" className=" w-full px-[12%] py-10 scroll-mt-20 ">
      ...
      <a
        href=""
        className="w-max flex items-center justify-center gap-2 text-gray-700 border-[0.5px] border-gray-700 rounded-full px-10 py-3 mx-auto my-20 hover:bg-light-hover duration-500"
      >
        Show more{" "}
        <Image
